...
@section('title', 'Commen Questions')
                ...
                <div class="card-body" style="min-height: calc(100vh - 196px);">
                    <div class="d-flex mb-3 justify-content-end">
                        <button type="button" class="btn btn-success float-start addButton mx-1" data-bs-toggle="modal"
                            data-bs-target="#createModal" model-title="Add Question" model-route="{{route('faqs.create')}}"
                            title="Add">
    ...
    <script>
        $(document).ready(function () {
            $('#dataTableObject').DataTable({
                ...
                ajax: '{{ route('faqs.data') }}', // Route for server-side processing
                columns: [
                    { data: 'id' },
                    { data: 'title' },
                    { data: 'action' },
